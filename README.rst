...
:Download: https://github.com/luismayta/zsh-yarn
:Source: https://github.com/luismayta/zsh-yarn
:Keywords: zsh-yarn
...
2. Clone the plugin
    ``bash   git clone https://github.com/luismayta/zsh-yarn``\ bash
3. Edit your ``.zshrc`` and add
    ``plugins=( ... zsh-yarn )`` to your list of
    plugins
...
1. Add :
    ...
    .. code-block:: bash
        ...
        antibody bundle luismayta/zsh-yarn

    to your ``.zshrc`` where you're adding your other plugins.
2. Either open a new terminal to force zsh to load the new plugin, or
    run ``antibody bundle luismayta/zsh-yarn`` in a
    running zsh session.
3. Enjoy!
...
.. |Build Status| image:: https://travis-ci.org/luismayta/zsh-yarn.svg
    :target: https://travis-ci.org/luismayta/zsh-yarn
.. |GitHub issues| image:: https://img.shields.io/github/issues/luismayta/zsh-yarn.svg
    :target: https://github.com/luismayta/zsh-yarn/issues
